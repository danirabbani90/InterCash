...
This mechanism has been integrated into Bitcore-Node-Intercash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Intercash/insight-api-Intercash#web-socket-api](https://github.com/Intercash/insight-api-Intercash#web-socket-api)
* API: [https://github.com/Intercash/insight-api-Intercash#swifttx-transactions](https://github.com/Intercash/insight-api-Intercash#swifttx-transactions)
...
By default, the Intercash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Intercash Core daemon:
