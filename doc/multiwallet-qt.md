...
In order to support loading of multiple wallets in Intercash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Intercash.cpp.
...
Changes to Intercash.cpp
----------------------
Intercash.cpp is the entry point into Intercash-qt, and as such, will require some minor modifications to provide hooks for
