...
Intro
-----
Intercash (ITC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Intercash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run Intercash-qt.exe.

Intercash Core is the original Intercash client and it builds the backbone of the network.
However, it downloads and stores the entire history of Intercash transactions;
