...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/Intercash-cli.cpp \
           src/Intercash-tx.cpp \
           src/Intercash.cpp \
           src/db.cpp \
           ...
           src/qt/Intercash.cpp \
           src/qt/Intercashstrings.cpp \
...
RESOURCES += src/qt/Intercash.qrc src/qt/Intercash_locale.qrc

TRANSLATIONS += src/qt/locale/Intercash_bg.ts \
                src/qt/locale/Intercash_de.ts \
                src/qt/locale/Intercash_en.ts \
                src/qt/locale/Intercash_es.ts \
                src/qt/locale/Intercash_fi.ts \
                src/qt/locale/Intercash_fr.ts \
                src/qt/locale/Intercash_it.ts \
                src/qt/locale/Intercash_ja.ts \
                src/qt/locale/Intercash_pl.ts \
                src/qt/locale/Intercash_pt.ts \
                src/qt/locale/Intercash_ru.ts \
                src/qt/locale/Intercash_sk.ts \
                src/qt/locale/Intercash_sv.ts \
                src/qt/locale/Intercash_vi.ts \
                src/qt/locale/Intercash_zh_CN.ts \
                src/qt/locale/Intercash_zh_TW.ts
