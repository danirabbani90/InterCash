...
This means one can have an always-on Intercashd instance running, and another local Intercashd/Intercash-qt instance which connects to this node and receives blocks from it.
