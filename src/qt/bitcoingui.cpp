                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Intercash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ITC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Intercash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Intercash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Intercash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Intercash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ITC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ITC addresses"));
    ...
    openAction->setStatusTip(tr("Open a Intercash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Intercash Core help message to get a list with possible Intercash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Intercash Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Intercash Core"); // default title
