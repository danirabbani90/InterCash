...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Intercash features */
        {"Intercash", "masternode", &masternode, true, true, false},
        {"Intercash", "listmasternodes", &listmasternodes, true, true, false},
        {"Intercash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Intercash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Intercash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Intercash", "masternodedebug", &masternodedebug, true, true, false},
        {"Intercash", "startmasternode", &startmasternode, true, true, false},
        {"Intercash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Intercash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Intercash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Intercash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Intercash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Intercash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Intercash", "mnbudget", &mnbudget, true, true, false},
        {"Intercash", "preparebudget", &preparebudget, true, true, false},
        {"Intercash", "submitbudget", &submitbudget, true, true, false},
        {"Intercash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Intercash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Intercash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Intercash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Intercash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Intercash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Intercash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Intercash", "checkbudgets", &checkbudgets, true, true, false},
        {"Intercash", "mnsync", &mnsync, true, true, false},
        {"Intercash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
static void RPCAcceptHandler(boost::shared_ptr<basic_socket_acceptor<Protocol> > acceptor,
    ...
    const boost::system::error_code& error)
{
    // Immediately start accepting new connections, except when we're canitced or our socket is closed.
...
void StopRPCThreads()
{
    ...
    BOOST_FOREACH (const boost::shared_ptr<ip::tcp::acceptor>& acceptor, rpc_acceptors) {
        acceptor->cancel(ec);
        if (ec)
            LogPrintf("%s: Warning: %s when canitcing acceptor", __func__, ec.message());
    }
    rpc_acceptors.clear();
    BOOST_FOREACH (const PAIRTYPE(std::string, boost::shared_ptr<deadline_timer>) & timer, deadlineTimers) {
        timer.second->cancel(ec);
        if (ec)
            LogPrintf("%s: Warning: %s when canitcing timer", __func__, ec.message());
    }
...
{
    return "> Intercash-cli " + methodname + " " + args + "\n";
}
