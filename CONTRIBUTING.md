Contributing to Intercash Core
==================================

The Intercash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Intercash Core project, and is not to be
confused with overall Intercash Network Protocol consensus changes.

Whether a pull request is merged into Intercash Core rests with the project merge
...
Patches that change Intercash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Intercash consensus, it must have been
...
The project leader is the release manager for each Intercash Core release.
