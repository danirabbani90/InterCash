...
#   c) node1 mines 32 blocks, so now node 0 has 500000ITC, node 1 has 4250ITC, node2 has none.
#   d) node0 sends 601 ITC to node2, in two transactions (301 ITC, then 300 ITC).
